...
class GradesControllerTest < ActionController::TestCase
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post :create, grade: { child_id: @grade.child_id, date: @grade.date, grade: @grade.grade, title: @grade.title }
    end
  ...
  test "should update grade" do
    patch :update, id: @grade, grade: { child_id: @grade.child_id, date: @grade.date, grade: @grade.grade, title: @grade.title }
    assert_redirected_to grade_path(assigns(:grade))
  end
